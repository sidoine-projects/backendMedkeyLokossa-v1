...
class ActivityLogRequest extends BaseRequest {
    ...
    protected $entite = "ActivityLog"; //Nom de l'objet, pour les permissions par exemple
    protected $nom_param_route = "activity_log"; //request route parameter
    protected $nom_table_suffixe = "activity_logs"; //le nom de la table sans prefixe
    protected $prefixe_table = null;   //prefixe des tables du module
    protected $nom_table = null; //le nom de la table sans prefixe

    public function __construct() {
        parent::__construct();
        $this->prefixe_table = config('tracking.prefixe_table');
