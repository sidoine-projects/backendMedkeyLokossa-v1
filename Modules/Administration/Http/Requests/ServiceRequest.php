...
class ServiceRequest extends BaseRequest
{
    ...
    protected $entite = "Service"; //Nom de l'objet, pour les permissions par exemple
    protected $nom_param_route = "service"; //request route parameter
    protected $nom_table_suffixe = "services"; //le nom de la table sans prefixe
