...
<body>
    ...
    <div class="container-fluid row">
        ...
        <div class="image-container  col-sm-12">
            <img src="{{ public_path('images/logo.png') }}" alt="logo" class="logo-image" style="width: 10% !important; height:  6% !important; " />
            <img src="{{ public_path('images/santee.png') }}" alt="logo" class="santee-image text-right" style="width:20% !important; height:5% !important; margin-left: 69%" />
        </div>
        ...
        <div class="row col-sm-12  ">
            <div class="col-sm-6 text-left ">
                ...
                <p><strong>{{ $patientInfo->lastname }} {{ $patientInfo->firstname }}</strong></p>
            ...
            <div class="col-sm-6 text-right" style="margin-left: 50%; margin-top: -50%">
                @if (count($facturesTypeP) > 0)
                <h4>FACTURE N° {{ $facturesTypeP[0]['reference'] }}</h4>
                <p style="margin-top: -10px !important;"><strong>Date :
                        {{ formatDate($facturesTypeP[0]['created_at']) }} </strong></p>
                @endif
                <p style="margin-top: -10px !important;"><strong>LOKOSSA ATHIEME</strong></p>
        ...
        <div class="table-responsive" style="margin-top: 2%;">
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    @foreach ($facturesTypeP as $facture)
                    <tr>
                        <td>{{ $facture['code'] }}</td>
                        <td>{{ $facture['designation'] }}</td>
                        <td style="text-align: center">{{ $facture['quantite'] }}</td>
                        <td style="text-align: right">{{ format_number_decimal($facture['prix']) }}</td>
                        <td style="text-align: right">{{ format_number_decimal($facture['amount']) }}</td>
                        @php
                ...
                <tfoot>
                    <tr>
                        ...
                        <td style="text-align: right">
                            <strong>{{ format_number_decimal($total) }} FCFA</strong>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right">
                            ...
                            if (count($facturesTypeP) > 0) {
                            $montantPrisenchargePourcentage = ($total * $facturesTypeP[0]['percentageassurance']) /100;
                            }
                            @endphp
                            <strong>{{ format_number_decimal($montantPrisenchargePourcentage) }} FCFA</strong>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="background-color: rgb(213, 219, 218); text-align: right">
                            <strong>{{ format_number_decimal($total - $montantPrisenchargePourcentage) }} FCFA</strong>
                        </td>
                    </tr>
                </tfoot>
            </table>
            ...
            <div class="row row-margin">
                <div class="col-sm-8">
                    {{-- @if (isset($facturesTypeP[0]['mode_payements_id']) && count($facturesTypeP) > 0)
                    <p style="font-size: 14px">
                        <strong style="text-transform: capitalize">
                            MODE DE PAIEMENT :
                            @if ($facturesTypeP[0]['mode_payements_id'] == 1)
                            ESPECE
                            @elseif($facturesTypeP[0]['mode_payements_id'] == 2)
                            MTN MOBILE MONEY
                            @elseif($facturesTypeP[0]['mode_payements_id'] == 3)
                            MOOV MONEY (FLOOZ)
                            @elseif($facturesTypeP[0]['mode_payements_id'] == 4)
                            CELTIS
                            @elseif($facturesTypeP[0]['mode_payements_id'] == 5)
                            CARTE BANCAIRE
                            @elseif($facturesTypeP[0]['mode_payements_id'] == 6)
                            CARTE DE CRÉDIT
                            @elseif($facturesTypeP[0]['mode_payements_id'] == 7)
                            PAIEMENT TRESORPAY
                            @elseif($facturesTypeP[0]['mode_payements_id'] == 8)
                            PAIEMENT A CREDIT
                            @endif
                        </strong>
                    </p>
                    ...
                    <p>
                        <a href="{{ asset('storage/pdf/facture_pharmacie_' . $codeUnique . '.pdf') }}" target="_blank">
...
@endif
                ...
                <div class="col-sm-4 text-right " style="margin-left: 50%; margin-top: -50%">
                    ...
                    <img src="{{ public_path('images/signature.png') }}" alt="logo" class="" style="width: 80px" />
