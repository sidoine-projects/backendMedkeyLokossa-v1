 ...
 */
class RoleRepository extends AppBaseRepository implements RepositoryInterface {
    ...
    // public function majRole($uuid) {
    //     $role = $this->findByUuid($uuid)->first();
    
    //     $this->update([], $role->id); // Retirez complètement la ligne 'display_name' => $attributs['display_name'],
