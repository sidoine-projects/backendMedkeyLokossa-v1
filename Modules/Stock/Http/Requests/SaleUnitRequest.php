...
class SaleUnitRequest extends BaseRequest {

    protected $entite = "SaleUnit"; //Nom de l'objet, pour les permissions par exemple
    protected $nom_param_route = "sale_unit"; //request route parameter
    protected $nom_table_suffixe = "sale_units"; //le nom de la table sans prefixe
