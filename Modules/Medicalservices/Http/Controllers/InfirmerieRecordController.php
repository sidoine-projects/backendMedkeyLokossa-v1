...
use Modules\Medicalservices\Entities\InfirmerieRecord;

class InfirmerieRecordController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
       ...
       $odlRecord = InfirmerieRecord::where('services_id', $request->services_id)
       ...
       $record = InfirmerieRecord::create([
          'uuid'=> Str::uuid(),
...
$record = InfirmerieRecord::where('services_id', $request->services_id)
->where('movments_id', $request->movments_id)->first();
