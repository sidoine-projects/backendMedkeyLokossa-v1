...
use Modules\Medicalservices\Entities\PediatrieRecord;

class PediatrieRecordController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $odlRecord = PediatrieRecord::where('services_id', $request->services_id)
   ...
   public function getRecord(Request $request)
   {
    ...
    $record = PediatrieRecord::where('services_id', $request->services_id)
    ->where('movments_id', $request->movments_id)->first();
